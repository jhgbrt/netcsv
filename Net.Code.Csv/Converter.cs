...
namespace Net.Code.Csv
{
    ...
    public class Converter : IConverter
    {
        ...
        bool IConverter.ToBoolean(string value) => ToBoolean(value);
        byte IConverter.ToByte(string value) => ToByte(value);
        char IConverter.ToChar(string value) => ToChar(value);
        DateTime IConverter.ToDateTime(string value) => ToDateTime(value);
        decimal IConverter.ToDecimal(string value) => ToDecimal(value);
        Guid IConverter.ToGuid(string value) => ToGuid(value);
        short IConverter.ToInt16(string value) => ToInt16(value);
        int IConverter.ToInt32(string value) => ToInt32(value);
        long IConverter.ToInt64(string value) => ToInt64(value);
        sbyte IConverter.ToSByte(string value) => ToSByte(value);
        float IConverter.ToSingle(string value) => ToSingle(value);
        double IConverter.ToDouble(string value) => ToDouble(value);
        ushort IConverter.ToUInt16(string value) => ToUInt16(value);
        uint IConverter.ToUInt32(string value) => ToUInt32(value);
        ulong IConverter.ToUInt64(string value) => ToUInt64(value);
    }
}